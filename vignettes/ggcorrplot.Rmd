...
With `"number"`, the coefficient text is colored by its value on a darkened copy
of the fill ramp, so the polarity still reads at a glance while a near-zero
coefficient stays legible against the panel.
